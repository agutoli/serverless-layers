          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 17:
                ...
                lockDependencies = parsedRemotePackageLock.dependencies.filter(function (dependency) {
                  return dependency.dev !== true;
                });
                localLockDependencies = this.localPackageLock.dependencies.filter(function (dependency) {
                  return dependency.dev !== true;
                });
                _context2.next = 24;
                return this.isDiff(lockDependencies, localLockDependencies);

              case 24:
                isDifferentPackageLock = _context2.sent;
                _context2.next = 28;
                break;
