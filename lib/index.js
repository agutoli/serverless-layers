...
var ServerlessLayers = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
        ...
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 13:
                currentLayerARN = _context5.sent;
                ...
                this.log("".concat(chalk.inverse.green(' No changes '), "! Using same layer arn: ").concat(this.logArn(currentLayerARN)));
    ...
    value: function getOutputLogicalId() {
      var value = this.getLayerName().replace(this.getStackName() + '-', '');
    ...
    value: function relateLayerWithFunctions(layerArn) {
      ...
      Object.keys(functions).forEach(function (funcName) {
        ...
        if (isEnabled) {
          ...
          _this3.log("function.".concat(chalk.magenta.bold(funcName), " - ").concat(_this3.logArn(layerArn)), ' ✓');
        } else {
          _this3.warn("(Skipped) function.".concat(chalk.magenta.bold(funcName)), " x");
        }
      });
    ...
    value: function getDependenciesList() {
      ...
      return Object.keys(this.localPackage.dependencies || []).map(function (x) {
        return "".concat(x, "@").concat(_this4.localPackage.dependencies[x]);
      });
    }
  }, {
    key: "finalizeDeploy",
            ...
            switch (_context7.prev = _context7.next) {
              case 0:
                ...
                Object.keys(this.service.functions).forEach(function (funcName) {
                  var lambdaFunc = _this5.service.functions[funcName];
                  var layers = lambdaFunc.layers || [];

                  if (!cliOpts["function"] && layers.length === 0) {
                    _this5.warn("(skipped) function.".concat(chalk.magenta.bold(funcName)));
                  ...
                  layers.forEach(function (currentLayerARN) {
                    if (cliOpts["function"] && cliOpts["function"] === funcName) {
                      _this5.log("function.".concat(chalk.magenta.bold(funcName), " = layers.").concat(_this5.logArn(currentLayerARN)));
