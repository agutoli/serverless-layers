  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 11:
                ...
                this.log("remoteHashFile: ".concat(remoteHashFile));
                this.log("remoteHash: ".concat(remoteHash));
                this.log("this.settings.customHash: ".concat(this.settings.customHash));
    ...
    value: function () {
      var _main = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee6() {
        var _this$settings, arn, localDir, artifact, forceInstall, dependencyInstall, hasSettingsChanges, hasFoldersChanges, hasDepsChanges, hasZipChanged, hashCustomHashChanged, verifyChanges, existentLayerArn, skipInstallation, version;
