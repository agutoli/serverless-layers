...
module.exports = function ($sls, injections) {
  var service = $sls.service; // pre validation

  checkRequirements($sls);

  var _dependencies$injecti = _objectSpread({}, dependencies, {}, injections),
      path = _dependencies$injecti.path,
      BbPromise = _dependencies$injecti.BbPromise,
      DeployCommand = _dependencies$injecti.DeployCommand,
      checkRequirements = _dependencies$injecti.checkRequirements;
  /**
   * Default options
   */
