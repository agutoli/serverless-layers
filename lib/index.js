  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
    ...
    value: function () {
      var _main = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
        var hasSettingsChanges, hasFoldersChanges, hasDepsChanges, hasZipChanged, verifyChanges, existentLayerArn, skipInstallation, version;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 31:
                ...
                skipInstallation = !verifyChanges && !this.settings.forceInstall && existentLayerArn;
                /**
    ...
    value: function mergePackageOptions() {
      var _this$settings = this.settings,
          packageExclude = _this$settings.packageExclude,
          artifact = _this$settings.artifact;
