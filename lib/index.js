...
var ServerlessLayers = /*#__PURE__*/function () {
  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
    ...
    value: function getSettings() {
      ...
      var keys = Object.keys(inboundSettings);
      ...
      if (keys.length > 1) {
        ...
        keys.forEach(function (layerOpt) {
    ...
    value: function hasSettingsChanged() {
      var _this3 = this;

      var manifest = '__meta__/manifest-settings.json';
      var currentSettings = JSON.stringify(this.settings);
    ...
    value: function () {
      var _main = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
        var hasSettingsChanged, hasFoldersChanged, hasDepsChanged, hasChanged, currentLayerARN, version;
        return _regenerator["default"].wrap(function _callee5$(_context5) {
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 11:
                hasSettingsChanged = _context5.sent;
                ...
                _context5.next = 16;
                return this.localFolders.hasFoldersChanged();

              case 16:
                hasFoldersChanged = _context5.sent;
              ...
              case 21:
                hasDepsChanged = _context5.sent;

              case 22:
                // check if something has changed
                hasChanged = !hasFoldersChanged && !hasDepsChanged && !hasSettingsChanged; // merge package default options
