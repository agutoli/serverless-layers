  ...
  (0, _createClass2["default"])(ServerlessLayers, [{
    ...
    value: function () {
      var _main = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee5() {
        var hasSettingsChanges, hasFoldersChanges, hasDepsChanges, verifyChanges, existentLayerArn, skipInstallation, version;
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              ...
              case 22:
                ...
                verifyChanges = [hasDepsChanges, hasFoldersChanges, hasSettingsChanges].some(function (x) {
                  return x === true;
