...
function () {
  function ServerlessLayers(serverless, options) {
    ...
    this.localPackage = require(path.join(process.env.PWD, this.settings.packagePath));
  }
  ...
  (0, _createClass2.default)(ServerlessLayers, [{
    ...
    value: function getOutputs() {
      ...
      var logicalId = this.provider.naming.getDeploymentBucketOutputLogicalId();
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee() {
        ...
        var bucketName, packagesTags, params;
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              ...
              case 2:
                ...
                packagesTags = this.getDependenciesList().join('\n');
                params = {
                  Content: {
                    S3Bucket: bucketName,
    ...
    value: function relateLayerWithFunctions(layerArn) {
      ...
      for (var funcName in this.service.functions) {
          ...
          while (1) {
            switch (_context6.prev = _context6.next) {
              ...
              case 27:
                ...
                return _context6.abrupt("return", this.relateLayerWithFunctions(version.LayerVersionArn));
    ...
    value: function getDependenciesList() {
      ...
      return Object.keys(this.localPackage.dependencies).map(function (x) {
        return "".concat(x, "@").concat(_this7.localPackage.dependencies[x]);
      });
    }
  }, {
            ...
            switch (_context7.prev = _context7.next) {
              ...
              case 5:
                return _context7.abrupt("return", new Promise(function (resolve) {
                  copyFile(_this8.settings.packagePath, path.join(nodeJsDir, 'package.json'), function (err) {
                    if (err) throw err; // install deps
                    ...
                    install(_this8.getDependenciesList(), opts, function (err) {
    ...
    value: function () {
      ...
      _regenerator.default.mark(function _callee8() {
        var currentLayerARN, functions, funcName;
          ...
          while (1) {
            switch (_context8.prev = _context8.next) {
              ...
              case 2:
                ...
                functions = this.service.functions;

                for (funcName in this.service.functions) {
                  this.log("function.".concat(funcName, " = layers.").concat(currentLayerARN));
                }
