...
var UploadService = /*#__PURE__*/function (_AbstractService) {
  ...
  var _super = _createSuper(UploadService);
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                return _context.abrupt("return", this.awsRequest('S3:putObject', params, {
                  checkError: true
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                return _context2.abrupt("return", this.awsRequest('S3:putObject', params, {
                  checkError: true
                }).then(function (result) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                ...
                return _context3.abrupt("return", this.awsRequest('S3:getObject', params).then(function (result) {
                  return result.Body.toString();
                })["catch"](function (e) {
                  _this3.plugin.log("".concat(filename, " ").concat(e.message, "."));
          ...
          while (1) {
            switch (_context4.prev = _context4.next) {
              case 0:
                ...
                return _context4.abrupt("return", this.awsRequest('S3:putObject', params, {
                  checkError: true
                }).then(function (result) {
          ...
          while (1) {
            switch (_context5.prev = _context5.next) {
              case 0:
                ...
                return _context5.abrupt("return", this.awsRequest('S3:getObject', params).then(function (result) {
                  return result.Body.toString();
                })["catch"](function (e) {
                  _this5.plugin.log("".concat(dependenciesPath, " ").concat(e.message, "."));
