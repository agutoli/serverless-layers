  ...
  (0, _createClass2["default"])(Dependencies, [{
    ...
    value: function () {
      var _install = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
        var _this$plugin$settings, copyBeforeInstall, copyAfterInstall, renameFilename, index, filename, commands, _this$plugin$settings2, packageManagerExtraArgs, packageManager, _index, pathTo, pathFrom, _yield$resolveFile, _yield$resolveFile2, from, to;
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              ...
              case 25:
                ...
                _context2.t7 = chalk;
                _context2.next = 31;
                return this.run("".concat(commands[packageManager], " ").concat(packageManagerExtraArgs));
              ...
              case 50:
                _context2.prev = 50;
                _context2.t12 = _context2["catch"](45);
