...
var LocalFolders = /*#__PURE__*/function (_AbstractService) {
  ...
  (0, _createClass2["default"])(LocalFolders, [{
    ...
    key: "hasFoldersChanged",
    value: function () {
      var _hasFoldersChanged = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee2() {
        var _this = this;
      ...
      function hasFoldersChanged() {
        return _hasFoldersChanged.apply(this, arguments);
      }

      return hasFoldersChanged;
    }()
  }, {
    key: "copyFolders",
    value: function () {
